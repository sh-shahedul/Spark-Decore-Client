...
const OurGallery = () => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-white via-amber-50/30 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
      {/* Background Decorative Elements */}
      <div className="absolute top-10 right-10 w-64 h-64 bg-amber-200/20 dark:bg-amber-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-teal-200/20 dark:bg-teal-500/10 rounded-full blur-3xl"></div>
      ...
      <Container>
        <div className="py-16 lg:py-20 relative z-10">
          ...
          <div className="text-center mb-12 space-y-4">
            <div className="inline-block animate-bounce">
              <span className="bg-gradient-to-r from-[#FAB12F] to-amber-500 dark:from-amber-400 dark:to-amber-500 text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider shadow-lg">
                ✨ Visual Showcase
              </span>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              <div className="h-1 w-16 bg-gradient-to-r from-transparent to-[#FAB12F] dark:to-amber-400 rounded-full"></div>
              <div className="h-1.5 w-10 bg-[#FAB12F] dark:bg-amber-400 rounded-full"></div>
              <div className="h-1 w-16 bg-gradient-to-l from-transparent to-[#FAB12F] dark:to-amber-400 rounded-full"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {currentImages.map((img, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl shadow-lg dark:shadow-gray-900/50 hover:shadow-2xl dark:hover:shadow-gray-900/70 transition-all duration-500 transform hover:-translate-y-2"
                style={{
                  animation: `fadeInUp 0.6s ease-out ${index * 0.1}s both`
                }}
              >
                ...
                <div className="relative overflow-hidden aspect-[4/5]">
                  ...
                  {/* Hover Border Effect */}
                  <div className="absolute inset-0 border-4 border-[#FAB12F]/0 dark:border-amber-400/0 group-hover:border-[#FAB12F]/50 dark:group-hover:border-amber-400/50 transition-all duration-500 rounded-2xl"></div>
                </div>

                {/* Image Number Badge */}
                <div className="absolute top-3 right-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm text-[#005461] dark:text-teal-400 font-bold text-xs px-3 py-1.5 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  #{startIndex + index + 1}
                </div>

                {/* Bottom Info Bar */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#005461] dark:from-teal-700 to-transparent p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                  <div className="flex items-center justify-between text-white">
                    <span className="text-sm font-semibold">View Details</span>
                    <svg 
                      className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" 
            ...
            <button
              ...
              className={`md:px-4 px-2 md:py-3 py-1 rounded-xl font-semibold transition-all duration-300 flex items-center gap-2 ${
                currentPage === 1
                  ...
                  : "bg-white dark:bg-gray-800 text-[#005461] dark:text-teal-400 hover:bg-[#005461] dark:hover:bg-teal-600 hover:text-white shadow-lg hover:shadow-xl border-2 border-[#005461]/20 dark:border-teal-600/20"
              }`}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            ...
            <div className="flex gap-2">
              {[...Array(totalPages).keys()].map((num) => (
                <button
                  ...
                  className={`md:w-12 w-8 md:h-12 h-8 rounded-xl text-sm font-bold transition-all duration-300 transform hover:scale-110 ${
                    currentPage === num + 1
                      ? "bg-gradient-to-br from-[#FAB12F] to-amber-500 dark:from-amber-400 dark:to-amber-500 text-white shadow-lg shadow-amber-300/50 dark:shadow-amber-500/30 scale-110"
                      : "bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border-2 border-gray-200 dark:border-gray-700 hover:border-[#FAB12F]/50 dark:hover:border-amber-400/50"
                  }`}
                >
                  {num + 1}
                </button>
