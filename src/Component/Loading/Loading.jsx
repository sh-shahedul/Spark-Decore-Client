    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
            <div className="text-center">
                ...
                {/* Loading Text */}
                <h2 className="text-2xl font-semibold text-gray-800 mb-2 dark:text-cyan-400 ">Loading...</h2>
                <p className="text-gray-600 dark:text-cyan-400 ">Please wait while we load your content</p>
