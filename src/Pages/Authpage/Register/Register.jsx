...
//       })
//       .catch(error => console.log('Firebase user creation error:', error));
//   };
...
//                   <option value="decorator">Decorator</option>
//                 </select>
//                 {errors.role && <p className="text-red-600 text-sm mt-1">Role is Required</p>}
//               </div> */}
