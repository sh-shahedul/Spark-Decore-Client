 ...
 if(loading) return <Loading></Loading>
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* Hero Section */}
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#005461]/10 to-[#FAB12F]/10 dark:from-teal-500/10 dark:to-amber-500/10"></div>
        <div className="container mx-auto px-4 relative z-10">
          <motion.div 
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 mt-5">
              <span className="text-[#005461] dark:text-teal-400">Transforming</span>{' '}
              <span className="text-[#FAB12F] dark:text-amber-400">Spaces,</span>{' '}
              <span className="text-[#005461] dark:text-teal-400">Creating</span>{' '}
              <span className="text-[#FAB12F] dark:text-amber-400">Memories</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="text-center"
              >
                <div className="text-4xl font-bold text-[#005461] dark:text-teal-400 mb-2">{stat.number}</div>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div 
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="mission-card bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl dark:shadow-gray-900/50 border-l-4 border-[#005461] dark:border-teal-500"
            >
              <div className="flex items-center mb-6">
                <div className="p-3 rounded-full bg-[#005461]/10 dark:bg-teal-500/20 mr-4">
                  <FaBullseye className="text-3xl text-[#005461] dark:text-teal-400" />
                </div>
                <h2 className="text-3xl font-bold text-[#005461] dark:text-teal-400">Our Mission</h2>
              </div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="mission-card bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl dark:shadow-gray-900/50 border-l-4 border-[#FAB12F] dark:border-amber-400"
            >
              <div className="flex items-center mb-6">
                <div className="p-3 rounded-full bg-[#FAB12F]/10 dark:bg-amber-400/20 mr-4">
                  <FaEye className="text-3xl text-[#FAB12F] dark:text-amber-400" />
                </div>
                <h2 className="text-3xl font-bold text-[#FAB12F] dark:text-amber-400">Our Vision</h2>
              </div>
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                To become the leading platform for decoration services nationwide, known for 
                innovation, reliability, and transforming spaces into beautiful, functional 
      ...
      {/* Our Story */}
      <section className="py-20 bg-gradient-to-r from-[#005461]/5 to-[#FAB12F]/5 dark:from-teal-500/10 dark:to-amber-500/10">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            className="max-w-4xl mx-auto text-center"
          >
            <h2 className="text-4xl font-bold text-[#005461] dark:text-teal-400 mb-6">Our Story</h2>
      ...
      <section className="py-20 values-section">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-[#005461] dark:text-teal-400 mb-12">
            Our Core Values
          </h2>
          <motion.div 
            variants={staggerContainer}
          ...
          >
            {values.map((value, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="value-card bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg dark:shadow-gray-900/50 hover:shadow-xl dark:hover:shadow-gray-900/70 transition-shadow duration-300"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="p-4 rounded-full bg-gradient-to-br from-[#005461]/20 to-[#FAB12F]/20 dark:from-teal-500/20 dark:to-amber-400/20 mb-4">
                    <div className="text-2xl text-[#005461] dark:text-teal-400">
                      {value.icon}
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-[#005461] dark:text-teal-400 mb-2">
                    {value.title}
                  </h3>
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
       <Container>
         <div className="container mx-auto ">
          <h2 className="text-4xl font-bold text-center text-[#005461] dark:text-teal-400 mb-4">
            Meet Our Leadership
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                whileHover={{ y: -10 }}
                className="bg-gradient-to-b from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 shadow-lg dark:shadow-gray-900/50 hover:shadow-xl dark:hover:shadow-gray-900/70 transition-all duration-300"
              >
                <div className="w-24 h-24 rounded-full bg-gradient-to-r from-[#005461] to-[#FAB12F] dark:from-teal-500 dark:to-amber-400 mx-auto mb-4 flex items-center justify-center">
                  <img src={member.image} alt={member.name} className="w-full h-full object-cover rounded-full"/>
                </div>
                <h3 className="text-xl font-bold text-center text-[#005461] dark:text-teal-400 mb-1">
                  {member.name}
                </h3>
                <p className="text-[#FAB12F] dark:text-amber-400 text-center font-semibold mb-2">
                  {member.role}
                </p>
                <div className="space-y-2 mt-4">
                  <div className="flex items-center text-gray-600 dark:text-gray-300">
                    <FaAward className="mr-2 text-[#005461] dark:text-teal-400" />
                    <span>{member.experience} experience</span>
                  </div>
                  <div className="flex items-center text-gray-600 dark:text-gray-300">
                    <FaPaintBrush className="mr-2 text-[#005461] dark:text-teal-400" />
                    <span>{member.specialty}</span>
                  </div>
                </div>
              </motion.div>
      ...
      {/* Why Choose Us */}
      <section className="py-20 bg-gradient-to-br from-[#005461] to-[#003844] dark:from-teal-700 dark:to-teal-900 text-white">
        <Container>
          <div className="container mx-auto ">
          <h2 className="text-4xl font-bold text-center mb-12">
            Why Choose StyleDecor?
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="text-3xl mb-4 text-[#FAB12F] dark:text-amber-400">{item.icon}</div>
                <h3 className="text-xl font-bold mb-2">{item.title}</h3>
       ...
       <section className="py-16">
        <div className="container mx-auto ">
          <motion.div
            initial={{ scale: 0.95, opacity: 0 }}
            whileInView={{ scale: 1, opacity: 1 }}
            className="bg-gradient-to-r from-[#005461] to-[#FAB12F] dark:from-teal-600 dark:to-amber-500 rounded-2xl p-12 text-center"
          >
            <h2 className="text-4xl font-bold text-white mb-4">
              Ready to Transform Your Space?
            </h2>
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-white dark:bg-gray-800 text-[#005461] dark:text-teal-400 font-bold px-8 py-4 rounded-full text-lg hover:shadow-2xl transition-all duration-300"
            >
              Book Your Consultation Now
            </motion.button>
          </motion.div>
