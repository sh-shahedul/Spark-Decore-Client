...
//     try {
//       const res = await axiosSecure.get(`/services/${id}`);
//       setSelectedService(res.data); // prefill form
//       serviceUpdateModal.current.showModal();
//     } catch (err) {
//       console.error(err);
//     }
...
//         onClose={() => setSelectedService(null)} // reset when modal closes
//       >
//         <form
//           method="dialog"
//           className="modal-box flex flex-col gap-4 bg-white p-6 rounded-lg shadow-lg"
//           onSubmit={handleFormSubmit}
//         >
//           <h3 className="font-bold text-lg text-gray-700">Update Service</h3>
