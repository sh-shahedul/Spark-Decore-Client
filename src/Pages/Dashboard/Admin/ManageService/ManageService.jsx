...
//       <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-[#005461] text-center">
//         All Services
//       </h2>
...
//                 <th className="px-4 py-3 text-left">Cost (BDT)</th>
...
//                     />
//                   </td>
//                   <td className="px-4 py-2 text-gray-500 font-semibold"><span className="bg-purple-200 text-purple-600 font-semibold px-2 py-1 rounded-full" >{service.service_name}</span></td>
//                   <td className="px-4 py-2 text-yellow-500 font-semibold">{formatDate(service.createdAt)}</td>
//                   <td className="px-4 py-2"><span className="text-sky-600 bg-sky-100 px-2 py-1 rounded-full font-semibold">{service.service_category}</span></td>
//                   <td className="px-4 py-2 text-green-600 font-semibold">{service.cost}</td>
//                   <td className="px-4 py-2 font-semibold text-gray-500">{service.unit}</td>
               
//                   <td className="px-4 py-2 flex flex-wrap gap-2">
//                     <button
//                       onClick={() => handleUpdate(service._id)}
//                       className="bg-[#005461] text-white px-3 py-1 rounded-lg hover:bg-[#00414c] transition"
//                     >
//                       Update
//                     </button>
//                     <button
