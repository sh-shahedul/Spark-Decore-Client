...
const BookingHistory = () => {
    ...
    if (isLoading) return <p className="text-center mt-10 text-lg font-semibold">Loading...</p>;
    if (isError) return <p className="text-center mt-10 text-lg font-semibold text-red-500">Something went wrong!</p>;

    return (
        <div className="p-4 md:p-6 lg:p-8">
            <h1 className="text-3xl font-extrabold mb-6 text-pink-600 text-center">Booking History</h1>
