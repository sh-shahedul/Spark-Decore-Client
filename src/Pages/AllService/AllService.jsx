...
//                   : 'bg-[#005461] text-white hover:bg-[#FAB12F] shadow-md hover:shadow-lg'
//               }`}
//             >
//               <svg
//                 className="w-4 h-4"
...
//                         currentPage === page
//                           ? 'bg-[#FAB12F] text-white shadow-lg scale-110'
//                           : 'bg-white text-[#005461] hover:bg-[#005461] hover:text-white shadow-md hover:shadow-lg'
//                       }`}
//                     >
//                       {page}
//                     </button>
