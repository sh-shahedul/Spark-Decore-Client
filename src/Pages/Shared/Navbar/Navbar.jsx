...
//                 <ul
//                   tabIndex={0}
//                   className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-[#005461] backdrop-blur-xl rounded-box w-52"
//                 >
//                   {links}
//                 </ul>
//               </div>
...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-[500]">
      {/* Transparent / Glassmorphism Navbar */}
      <div className="bg-[#005461] dark:bg-gray-800 backdrop-blur-xl border-b border-white/20 dark:border-gray-700/30 shadow-sm">
        <Container>
          <div className="navbar">
            {/* Mobile Menu */}
            <div className="navbar-start">
