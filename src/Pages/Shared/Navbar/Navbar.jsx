...
const Navbar = () => {
  ...
  const linkStyle = ({ isActive }) =>
    `font-bold md:text-lg transition ${
      isActive ? "text-pink-500" : "text-black hover:text-pink-400"
    }`;
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-[500]">
      ...
      <div className="bg-white/10 backdrop-blur-xl border-b border-white/20 shadow-sm">
        <Container>
          <div className="navbar">
            {/* Mobile Menu */}
            <div className="navbar-start">
              ...
              <Link
                to="/"
                className="md:text-3xl text-lg text-pink-600 font-bold"
              >
                Spark <span className="text-black md:text-2xl text-lg">Decore</span>
              </Link>
            </div>
